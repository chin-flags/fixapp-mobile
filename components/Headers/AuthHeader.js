  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={{flexDirection: 'row',justifyContent: 'center', width:'100%', position:'absolute', bottom: Layout.sizes.padding / 2 }}>
        <Button
          style={[{width:'30%', marginRight: Layout.sizes.margin / 2}, !signInActive ? styles.active_button: {}]}
          mode='outlined'
          color={Colors.accent}
          onPress={()=>{setSignInActive(false)}}
        >
